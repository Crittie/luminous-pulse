...
> **Goal**: Build trust, deliver value, introduce the Emergency Grounding Kit ($9 tripwire) by email 2, and hint at deeper workbook collection
...
P.P.S. — I've also been building something bigger — a collection of printable workbooks for the specific things this transition throws at you: the grief, the identity crisis, the interview anxiety, the slow rebuilding. I'll share more soon. for now, just know: there's more here when you need it.
...
Tag: welcome-sequence-complete
    ↓ 2 days
Nurture sequence begins (5 emails: story → workbook intro → product range → proof → collection pitch)
```
