...
> **Target audience**: "Sam" — mid-career PM/engineer (30-40), laid off, silent sufferer, scrolling IG at 2am. See `customer-persona.md`.
...
> **Posting time**: Schedule key posts for 9pm-12am (Sam's active hours). Use Metricool.
> **CTA rules**: Sam never engages publicly. NO "tag a friend," "comment below," or "tell us in the comments." Use: save, screenshot, send via DM, link in bio. The only exception is "Comment GROUNDED" (ManyChat DM trigger — feels private enough).
> **Content priority**: Lead with permission hooks ("you don't have to...") and naming hooks ("the way your chest tightens when..."). Save human-vs-AI framing for month 2+.
> **Mix**: ~60% permission + naming (identity loss, grief, shame). ~30% grounding techniques (immediate value). ~10% soft product mention.

---

## Quote Card Captions (30 posts)
...
**Hashtag Set**: Core + Set 3 | **CTA**: send this to someone who needs it
...
You don't need a five-year plan for a world that changes every five months.
...
There is no training data for the way you held that conversation together when it was falling apart.

No model for the look you gave someone that told them they weren't alone.
...
### QC-8
**Affirmation**: "I wake up with something no machine ever will: a reason to care about today."

Machines don't have mornings. They don't have that moment where you decide what today means. They don't lie in bed and choose to get up anyway.
...
**Hashtag Set**: Core + Set 3 | **CTA**: save this for someone who does

---

### QC-10
**Affirmation**: "The things that make me human — doubt, courage, love — are features, not bugs."

We've been trained to see our emotions as inefficiencies. But doubt makes us careful. Courage makes us bold. Love makes us show up.
...
**Hashtag Set**: Core + Set 3 | **CTA**: send this to someone who forgot
...
Your worth does not boot up with your computer. It does not depend on your inbox count or your productivity score.
...
**Hashtag Set**: Core + Set 2 + Set 5 | **CTA**: DM us the hardest transition you've navigated. we read every one.
...
### QC-15
**Affirmation**: "there is no schedule for grief. there is no timeline for rebuilding."

everyone has an opinion about how long this should take. "it's been six weeks." "have you tried networking?" "you should be further along by now."

no. you should be exactly where you are. because this is where you are. and that's allowed.

**Hashtag Set**: Core + Set 2 | **CTA**: save this for the next time someone gives you a timeline.
**Note**: Month 1 priority. Speaks directly to Sam's shame about pace of recovery.

---

### QC-16
**Affirmation**: "I am not a prompt. I am the person behind it."

You are not your inputs. You are not your outputs. You are the consciousness that decided what to ask and what to do with the answer.

That's the part that matters.

**Hashtag Set**: Core + Set 3 | **CTA**: save this. come back when you need it.
...
### QC-18
**Affirmation**: "I am the author of this day. Not the algorithm, not the feed, not the forecast."

Before you scroll, before you check, before you react — remember: you decide what today means.

Not the timeline. Not the trending page. You.

**Hashtag Set**: Core + Set 2 | **CTA**: screenshot this before you open your inbox.
...
Tools change. You adapt. That's always been the deal.
...
Not every moment needs to be productive. Some moments just need to be felt.
...
### QC-22
**Affirmation**: "I trust my instincts more than any output. They have kept me alive this long."

Your gut feeling is not a glitch. It's decades of pattern recognition running in the background.

Trust it. It knows things the data doesn't.

**Hashtag Set**: Core + Set 3 | **CTA**: save this for someone with great instincts
...
**Hashtag Set**: Core + Set 2 + Set 5 | **CTA**: send this to someone mid-reinvention

---

### QC-24
**Affirmation**: "My ability to feel is not a flaw in the system. It is the system."

Empathy. Grief. Joy. Frustration. Love.
...
### QC-25
**Affirmation**: "I replace 'what if it all goes wrong' with 'what if I handle it.'"

Same energy. Completely different outcome.
...
You know that feeling when someone is fully with you? Not half-listening. Not checking their phone. Just there.

That is a gift no technology will ever deliver. And you give it every day.

**Hashtag Set**: Core + Set 3 | **CTA**: save this for someone who gives great presence
...
You are not a passive observer of what's happening. You are a participant. You are shaping this.
...
**Hashtag Set**: Core + Set 2 | **CTA**: save this. let it set your intention tomorrow.
...
Not the fastest person. Not the most connected. Not the one with the best tools.
...
save this for the days when LinkedIn makes you feel replaceable.

**Hashtag Set**: Core + Set 5 | **CTA**: Save + send to someone going through it
**Note**: Month 2+ content. Human-vs-AI framing. Don't lead with this — lead with permission/naming carousels.
...
save this. or send it to someone carrying the weight of a changing world.

**Hashtag Set**: Core + Set 5 | **CTA**: Save + send via DM
**Note**: Month 2+ content. Human-vs-AI framing.
...
swipe through. save the one that hits hardest. send it to someone who forgot.
...
### R-3: Guided affirmation (60 sec)
**Affirmation**: "I give myself permission to not know everything and still be enough."
...
**Hashtag Set**: Core + Set 3 | **CTA**: follow if this resonates. DM me your story — I read every one.
**Note**: Week 1-2 priority. Origin story builds trust. One of the first reels to post.
...
### R-7: Slow text reveal + ambient audio
**Affirmation**: "I have adapted before. I will adapt again. My resilience is not a theory — it is my lived history."

Your track record is 100%. Every hard thing. Every shift. Every "worst day." You're still here.
...
**Hashtag Set**: Core + Set 4 | **CTA**: DM + Follow
...
**Rotate CTAs weekly (Sam-safe — no public engagement required):**
- Week 1: Save + Screenshot focus
- Week 2: DM trigger (GROUNDED) + Link in bio focus
- Week 3: Send via DM + Save focus
- Week 4: Follow + Link in bio focus

**Never use**: "tag a friend," "comment your story," "tell us in the comments," "drop it below"
**Always safe**: save, screenshot, send via DM, link in bio, follow, comment GROUNDED (ManyChat)
